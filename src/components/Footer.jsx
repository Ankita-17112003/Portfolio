      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 text-center text-md-end text-light">
            <a href="https://www.linkedin.com/in/ankita-batwal" target="_blank" rel="noreferrer" className="text-white me-3">
              <i className="bi bi-linkedin" style={{ fontSize: "1.2rem" }}></i>
            </a>
            <a href="https://github.com/ankitabatwal" target="_blank" rel="noreferrer" className="text-white me-3">
              <i className="bi bi-github" style={{ fontSize: "1.2rem" }}></i>
            </a>
            <a href="mailto:batwalankita9975@gmail.com" className="text-white">
